 ...
 */
package de.wilkenk.ba.ide.contentassist.antlr;

import com.google.inject.Inject;
import de.wilkenk.ba.ide.contentassist.antlr.internal.InternalCreateParser;
...
public class CreateParser extends AbstractContentAssistParser {
	...
	@Override
	protected InternalCreateParser createParser() {
		InternalCreateParser result = new InternalCreateParser(null);
		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getAttributeAccess().getAlternatives_3_1(), "rule__Attribute__Alternatives_3_1");
					put(grammarAccess.getAttributeAccess().getValueTypeAlternatives_5_1_0(), "rule__Attribute__ValueTypeAlternatives_5_1_0");
					put(grammarAccess.getInitAttributeAccess().getAlternatives(), "rule__InitAttribute__Alternatives");
					...
					put(grammarAccess.getRaiseAccess().getAlternatives(), "rule__Raise__Alternatives");
					put(grammarAccess.getAttributeRaiseTypeAccess().getAlternatives(), "rule__AttributeRaiseType__Alternatives");
					put(grammarAccess.getCombinationRaiseTypeAccess().getAlternatives(), "rule__CombinationRaiseType__Alternatives");
					put(grammarAccess.getRelOpToAccess().getAlternatives(), "rule__RelOpTo__Alternatives");
					put(grammarAccess.getConditionTargetsAccess().getAlternatives(), "rule__ConditionTargets__Alternatives");
					...
					put(grammarAccess.getAttributePartAccess().getAlternatives(), "rule__AttributePart__Alternatives");
					put(grammarAccess.getCombinedAttributePartAccess().getAlternatives(), "rule__CombinedAttributePart__Alternatives");
					put(grammarAccess.getCombinationPartAccess().getAlternatives(), "rule__CombinationPart__Alternatives");
					put(grammarAccess.getDecisionTablePartAccess().getAlternatives(), "rule__DecisionTablePart__Alternatives");
					put(grammarAccess.getRowPartAccess().getAlternatives(), "rule__RowPart__Alternatives");
					put(grammarAccess.getConsequenceRefAccess().getAlternatives(), "rule__ConsequenceRef__Alternatives");
					...
					put(grammarAccess.getInitAttributeAccess().getGroup_0(), "rule__InitAttribute__Group_0__0");
					put(grammarAccess.getInitAttributeAccess().getGroup_1(), "rule__InitAttribute__Group_1__0");
					put(grammarAccess.getCategoryAccess().getGroup(), "rule__Category__Group__0");
					put(grammarAccess.getCombinedAttributeAccess().getGroup(), "rule__CombinedAttribute__Group__0");
					put(grammarAccess.getCombinedAttributeAccess().getGroup_9(), "rule__CombinedAttribute__Group_9__0");
					put(grammarAccess.getCombinedAttributeAccess().getGroup_10(), "rule__CombinedAttribute__Group_10__0");
					put(grammarAccess.getCombinedAttributeRefAccess().getGroup(), "rule__CombinedAttributeRef__Group__0");
					...
					put(grammarAccess.getCombinationRefAccess().getGroup(), "rule__CombinationRef__Group__0");
					put(grammarAccess.getCombinationConditionAccess().getGroup(), "rule__CombinationCondition__Group__0");
					put(grammarAccess.getDiceAccess().getGroup(), "rule__Dice__Group__0");
					put(grammarAccess.getDiceRefAccess().getGroup(), "rule__DiceRef__Group__0");
					put(grammarAccess.getAttributeRaiseAccess().getGroup(), "rule__AttributeRaise__Group__0");
					put(grammarAccess.getDiceBasedRaiseAccess().getGroup(), "rule__DiceBasedRaise__Group__0");
					put(grammarAccess.getConstantBasedRaiseAccess().getGroup(), "rule__ConstantBasedRaise__Group__0");
					put(grammarAccess.getCombinationRaiseAccess().getGroup(), "rule__CombinationRaise__Group__0");
					put(grammarAccess.getAddCombinationAccess().getGroup(), "rule__AddCombination__Group__0");
					put(grammarAccess.getDeleteCombinationAccess().getGroup(), "rule__DeleteCombination__Group__0");
					put(grammarAccess.getDecisionTableAccess().getGroup(), "rule__DecisionTable__Group__0");
					put(grammarAccess.getDecisionTableAccess().getGroup_2(), "rule__DecisionTable__Group_2__0");
					put(grammarAccess.getDecisionTableRefAccess().getGroup(), "rule__DecisionTableRef__Group__0");
					...
					put(grammarAccess.getRowRefAccess().getGroup(), "rule__RowRef__Group__0");
					put(grammarAccess.getConditionAccess().getGroup(), "rule__Condition__Group__0");
					put(grammarAccess.getRelOpToAccess().getGroup_4(), "rule__RelOpTo__Group_4__0");
					put(grammarAccess.getRelOpToAccess().getGroup_5(), "rule__RelOpTo__Group_5__0");
					put(grammarAccess.getConsequenceAccess().getGroup(), "rule__Consequence__Group__0");
					...
					put(grammarAccess.getPropertyAccess().getAttrValueAssignment_0_1(), "rule__Property__AttrValueAssignment_0_1");
					put(grammarAccess.getPropertyAccess().getCombAttrValueAssignment_1_1(), "rule__Property__CombAttrValueAssignment_1_1");
					put(grammarAccess.getPropertyAccess().getCombValueAssignment_2_1(), "rule__Property__CombValueAssignment_2_1");
					put(grammarAccess.getAttributeAccess().getNameAssignment_1(), "rule__Attribute__NameAssignment_1");
					put(grammarAccess.getAttributeAccess().getIntValueAssignment_3_1_0(), "rule__Attribute__IntValueAssignment_3_1_0");
					put(grammarAccess.getAttributeAccess().getStringValueAssignment_3_1_1(), "rule__Attribute__StringValueAssignment_3_1_1");
					put(grammarAccess.getAttributeAccess().getInitialValueAssignment_4_1(), "rule__Attribute__InitialValueAssignment_4_1");
					put(grammarAccess.getAttributeAccess().getValueTypeAssignment_5_1(), "rule__Attribute__ValueTypeAssignment_5_1");
					put(grammarAccess.getAttributeAccess().getMinValueAssignment_6_1(), "rule__Attribute__MinValueAssignment_6_1");
					put(grammarAccess.getAttributeAccess().getMaxValueAssignment_6_3(), "rule__Attribute__MaxValueAssignment_6_3");
					put(grammarAccess.getAttributeAccess().getCategoryAssignment_7_1(), "rule__Attribute__CategoryAssignment_7_1");
					put(grammarAccess.getAttributeAccess().getDescriptionAssignment_8_1(), "rule__Attribute__DescriptionAssignment_8_1");
					put(grammarAccess.getAttributeRefAccess().getAttributeAssignment_0(), "rule__AttributeRef__AttributeAssignment_0");
					put(grammarAccess.getAttributeRefAccess().getPartAssignment_2(), "rule__AttributeRef__PartAssignment_2");
					put(grammarAccess.getInitialAttributeDecisionAccess().getTypeAssignment(), "rule__InitialAttributeDecision__TypeAssignment");
					put(grammarAccess.getInitAttributeAccess().getInitValueAssignment_0_1(), "rule__InitAttribute__InitValueAssignment_0_1");
					put(grammarAccess.getInitAttributeAccess().getDiceEventAssignment_1_1(), "rule__InitAttribute__DiceEventAssignment_1_1");
					put(grammarAccess.getCategoryAccess().getNameAssignment_1(), "rule__Category__NameAssignment_1");
					put(grammarAccess.getCombinedAttributeAccess().getNameAssignment_1(), "rule__CombinedAttribute__NameAssignment_1");
					put(grammarAccess.getCombinedAttributeAccess().getMinValueAssignment_4(), "rule__CombinedAttribute__MinValueAssignment_4");
					put(grammarAccess.getCombinedAttributeAccess().getMaxValueAssignment_6(), "rule__CombinedAttribute__MaxValueAssignment_6");
					put(grammarAccess.getCombinedAttributeAccess().getCombValueAssignment_8(), "rule__CombinedAttribute__CombValueAssignment_8");
					put(grammarAccess.getCombinedAttributeAccess().getCategoryAssignment_9_1(), "rule__CombinedAttribute__CategoryAssignment_9_1");
					put(grammarAccess.getCombinedAttributeAccess().getDescriptionAssignment_10_1(), "rule__CombinedAttribute__DescriptionAssignment_10_1");
					put(grammarAccess.getCombinedAttributeRefAccess().getCombinedAttributeAssignment_0(), "rule__CombinedAttributeRef__CombinedAttributeAssignment_0");
					put(grammarAccess.getCombinedAttributeRefAccess().getPartAssignment_2(), "rule__CombinedAttributeRef__PartAssignment_2");
					...
					put(grammarAccess.getIntRefAccess().getIntValAssignment(), "rule__IntRef__IntValAssignment");
					put(grammarAccess.getCombinationAccess().getNameAssignment_1(), "rule__Combination__NameAssignment_1");
					put(grammarAccess.getCombinationAccess().getConditionsAssignment_3(), "rule__Combination__ConditionsAssignment_3");
					put(grammarAccess.getCombinationAccess().getRaiseAssignment_5(), "rule__Combination__RaiseAssignment_5");
					put(grammarAccess.getCombinationRefAccess().getCombinationAssignment_0(), "rule__CombinationRef__CombinationAssignment_0");
					put(grammarAccess.getCombinationRefAccess().getPartAssignment_2(), "rule__CombinationRef__PartAssignment_2");
					put(grammarAccess.getCombinationConditionAccess().getNameAssignment_1(), "rule__CombinationCondition__NameAssignment_1");
					put(grammarAccess.getCombinationConditionAccess().getConditionAssignment_3(), "rule__CombinationCondition__ConditionAssignment_3");
					put(grammarAccess.getDiceAccess().getNameAssignment_1(), "rule__Dice__NameAssignment_1");
					put(grammarAccess.getDiceAccess().getMaxValueAssignment_3(), "rule__Dice__MaxValueAssignment_3");
					put(grammarAccess.getDiceRefAccess().getDiceAssignment_0(), "rule__DiceRef__DiceAssignment_0");
					put(grammarAccess.getDiceRefAccess().getPartAssignment_2(), "rule__DiceRef__PartAssignment_2");
					put(grammarAccess.getDicePartAccess().getThrowAssignment(), "rule__DicePart__ThrowAssignment");
					put(grammarAccess.getAttributeRaiseAccess().getNameAssignment_1(), "rule__AttributeRaise__NameAssignment_1");
					put(grammarAccess.getAttributeRaiseAccess().getTargetAssignment_3(), "rule__AttributeRaise__TargetAssignment_3");
					put(grammarAccess.getAttributeRaiseAccess().getTriesAssignment_4(), "rule__AttributeRaise__TriesAssignment_4");
					put(grammarAccess.getAttributeRaiseAccess().getValueChangeAssignment_5(), "rule__AttributeRaise__ValueChangeAssignment_5");
					put(grammarAccess.getDiceBasedRaiseAccess().getDiceToUseAssignment_2(), "rule__DiceBasedRaise__DiceToUseAssignment_2");
					put(grammarAccess.getDiceBasedRaiseAccess().getResultAssignment_3(), "rule__DiceBasedRaise__ResultAssignment_3");
					put(grammarAccess.getConstantBasedRaiseAccess().getResultAssignment_2(), "rule__ConstantBasedRaise__ResultAssignment_2");
					put(grammarAccess.getCombinationRaiseAccess().getNameAssignment_1(), "rule__CombinationRaise__NameAssignment_1");
					put(grammarAccess.getCombinationRaiseAccess().getActionsAssignment_3(), "rule__CombinationRaise__ActionsAssignment_3");
					put(grammarAccess.getAddCombinationAccess().getAddAssignment_1(), "rule__AddCombination__AddAssignment_1");
					put(grammarAccess.getDeleteCombinationAccess().getDeleteAssignment_1(), "rule__DeleteCombination__DeleteAssignment_1");
					put(grammarAccess.getDecisionTableAccess().getNameAssignment_1(), "rule__DecisionTable__NameAssignment_1");
					put(grammarAccess.getDecisionTableAccess().getNumberConditionRowsAssignment_2_1(), "rule__DecisionTable__NumberConditionRowsAssignment_2_1");
					put(grammarAccess.getDecisionTableAccess().getNumberConsequenceRowsAssignment_2_3(), "rule__DecisionTable__NumberConsequenceRowsAssignment_2_3");
					put(grammarAccess.getDecisionTableAccess().getRowsAssignment_4(), "rule__DecisionTable__RowsAssignment_4");
					put(grammarAccess.getDecisionTableRefAccess().getDecisionTableAssignment_0(), "rule__DecisionTableRef__DecisionTableAssignment_0");
					put(grammarAccess.getDecisionTableRefAccess().getPartAssignment_2(), "rule__DecisionTableRef__PartAssignment_2");
					put(grammarAccess.getRowAccess().getIndexAssignment_1(), "rule__Row__IndexAssignment_1");
					put(grammarAccess.getRowAccess().getConditionsAssignment_3(), "rule__Row__ConditionsAssignment_3");
					put(grammarAccess.getRowAccess().getConditionsAssignment_4_1(), "rule__Row__ConditionsAssignment_4_1");
					put(grammarAccess.getRowAccess().getConsequencesAssignment_5(), "rule__Row__ConsequencesAssignment_5");
					put(grammarAccess.getRowAccess().getConsequencesAssignment_6_1(), "rule__Row__ConsequencesAssignment_6_1");
					put(grammarAccess.getRowRefAccess().getRowAssignment_0(), "rule__RowRef__RowAssignment_0");
					put(grammarAccess.getRowRefAccess().getPartAssignment_2(), "rule__RowRef__PartAssignment_2");
					put(grammarAccess.getConditionAccess().getCondNameAssignment_0(), "rule__Condition__CondNameAssignment_0");
					put(grammarAccess.getConditionAccess().getExpressionAssignment_2(), "rule__Condition__ExpressionAssignment_2");
					put(grammarAccess.getConditionAccess().getOpAssignment_3(), "rule__Condition__OpAssignment_3");
					put(grammarAccess.getConsequenceAccess().getTargetAssignment_0(), "rule__Consequence__TargetAssignment_0");
					put(grammarAccess.getConsequenceAccess().getEffectAssignment_1(), "rule__Consequence__EffectAssignment_1");
	...
	protected Collection<FollowElement> getFollowElements(AbstractInternalContentAssistParser parser) {
		try {
			InternalCreateParser typedParser = (InternalCreateParser) parser;
