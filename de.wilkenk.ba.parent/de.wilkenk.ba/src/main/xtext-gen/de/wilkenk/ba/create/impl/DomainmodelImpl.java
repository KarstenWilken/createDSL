...
public class DomainmodelImpl extends MinimalEObjectImpl.Container implements Domainmodel
{
  ...
  {
    return CreatePackage.Literals.DOMAINMODEL;
  }
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, CreatePackage.DOMAINMODEL__NAME, oldName, name));
  }
  ...
  public EList<Entity> getElements()
  {
    if (elements == null)
    {
      elements = new EObjectContainmentEList<Entity>(Entity.class, this, CreatePackage.DOMAINMODEL__ELEMENTS);
    }
    return elements;
  }
